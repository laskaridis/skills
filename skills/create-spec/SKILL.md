...
You are in **RESTRICTED EDIT MODE**. You are not allowed to modify any files in the codebase except the `spec.md` you need to create or unless the user explicitly instruct you otherise.
